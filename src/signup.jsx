    ...
    return (
      <div className='w-[100vw] h-[100vh] flex flex-col justify-center items-center'>
        ...
        <form className='w-[512px] pt-[72px] pb-[100px] px-[130px] bg-white text-center'>
          ...
          <button className='font-[700] text-[14px] text-[#fff] w-full py-[12px] bg-[#2D88D4] rounded-[4px] mb-[14px] cursor-pointer'>Sign up</button>
          <Link className="font-[700] text-[14px]  text-[#2D88D4]" to={'/login'}>Log in</Link>
        </form>
      </div>
    )
  }
